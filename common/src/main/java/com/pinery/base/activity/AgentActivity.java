...
public class AgentActivity extends RxAppCompatActivity {
   ...
   */
  public static void gotoFragment(Context context, Class<? extends BaseFragment> fragmentClass) {
   ...
   * @param bundle
   */
  public static void gotoFragment(Activity context, Class<? extends BaseFragment> fragmentClass,
