...
public class ToastView implements IToastView {
  ...
  @Override public void showShortToast(CharSequence text) {
    showToast(text, Toast.LENGTH_SHORT);
  }

  @Override public void showLongToast(CharSequence text) {
    showToast(text, Toast.LENGTH_LONG);
  }

  @Override public void showShortNewToast(CharSequence text) {
    showNewToast(text, Toast.LENGTH_SHORT);
  }

  @Override public void showLongNewToast(CharSequence text) {
