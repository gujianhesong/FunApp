...
public class HashTagItemBean {
  ...
  public static class AuthorBean {
    ...
    public static class CommerceInfoBean {
      ...
      public void setEnable_show_commerce_sale_item(boolean enable_show_commerce_sale_item) {
      ...
      public void setEnable_show_commerce_sale_live(boolean enable_show_commerce_sale_live) {
