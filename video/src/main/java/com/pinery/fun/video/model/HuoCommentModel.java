...
public class HuoCommentModel extends BaseModel<CommentBean> {

  public Disposable loadData(String id, int page, final OnDataCallback<CommentBean> callback) {
    ...
    return getApiService(HuoApi.Main, ApiService.class).loadComments(id, hashMap)
        ...
        .subscribe(new Consumer<CommentBean>() {
          @Override public void accept(@NonNull CommentBean commentBean) throws Exception {
            if (callback != null) {
