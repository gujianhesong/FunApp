...
public class HuoVideoModel extends BaseModel<HuoVideoBean> {
  ...
  @Override public Disposable requestData(final OnDataCallback<HuoVideoBean> callback) {
    return getApiService(HuoApi.Main, ApiService.class)
        .videobean()
  ...
  public Disposable firstRefreshData(final OnDataCallback<HuoVideoBean> callback) {
    HashMap<String, Object> hashMap = createHashMapWithCommonParams();

    return getApiService(HuoApi.Main, ApiService.class)
        .firstRefreshData(hashMap)
        .retryWhen(new RetryWithDelayFunc())
        .subscribeOn(Schedulers.io())
        .observeOn(AndroidSchedulers.mainThread())
        .subscribe(new Consumer<HuoVideoBean>() {
  ...
  public Disposable refreshData(final OnDataCallback<HuoVideoBean> callback) {
    HashMap<String, Object> hashMap = createHashMapWithCommonParams();
  ...
  public Disposable loadMoreData(int page, final OnDataCallback<HuoVideoBean> callback) {
    HashMap<String, Object> hashMap = createHashMapWithCommonParams();
