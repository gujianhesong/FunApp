...
public class SearchTagItemsBean {
  ...
  public static class HashtagsBean {
    ...
    public static class HashtagBean {
      ...
      public int getTips_time() {
        return tips_time;
      }

      public void setTips_time(int tips_time) {
      ...
      public void setTitle_img(TitleImgBean title_img) {
      ...
      public boolean isEnable_community() {
        return enable_community;
      }

      public void setEnable_community(boolean enable_community) {
        this.enable_community = enable_community;
      }
      ...
      public void setPop_tips(String pop_tips) {
        this.pop_tips = pop_tips;
      }
    ...
    public static class ItemsBean {
      ...
      public int getShare_strong_guide() {
        return share_strong_guide;
      }

      public void setShare_strong_guide(int share_strong_guide) {
        this.share_strong_guide = share_strong_guide;
      }

      public String getFollow_status_tag() {
        return follow_status_tag;
      }

      public void setFollow_status_tag(String follow_status_tag) {
      ...
      public void setFollow_display(boolean follow_display) {
        this.follow_display = follow_display;
      }
      ...
      public boolean isPrefetch_comment() {
        return prefetch_comment;
      }

      public void setPrefetch_comment(boolean prefetch_comment) {
        this.prefetch_comment = prefetch_comment;
      }
      ...
      public HashtagBeanX getHashtag() {
        return hashtag;
      }

      public void setHashtag(HashtagBeanX hashtag) {
        this.hashtag = hashtag;
      }
      ...
      public void setCommerce(CommerceBean commerce) {
      ...
      public boolean isDisable_watermark() {
        return disable_watermark;
      }

      public void setDisable_watermark(boolean disable_watermark) {
      ...
      public boolean isPrefetch_profile() {
        return prefetch_profile;
      }

      public void setPrefetch_profile(boolean prefetch_profile) {
        this.prefetch_profile = prefetch_profile;
      }

      public int getCan_duet() {
        return can_duet;
      }

      public void setCan_duet(int can_duet) {
        this.can_duet = can_duet;
      }
      ...
      public static class VideoBean {
        ...
        public Object getCover_animated() {
          return cover_animated;
        }

        public void setCover_animated(Object cover_animated) {
      ...
      public static class SongBean {
        ...
        private String original_titel_tpl;
        private long id;
        ...
        public boolean isShow_in_video() {
          return show_in_video;
        }

        public void setShow_in_video(boolean show_in_video) {
          this.show_in_video = show_in_video;
        }
        ...
        public void setOriginal_user_id(long original_user_id) {
        ...
        public String getOriginal_titel_tpl() {
          return original_titel_tpl;
        }

        public void setOriginal_titel_tpl(String original_titel_tpl) {
          this.original_titel_tpl = original_titel_tpl;
        }
      ...
      public static class HashtagBeanX {
        private int fav_cnt;
        private boolean is_visible;
        private int tips_time;
        private boolean enable_community;
        ...
        private String id_string;
        private TitleImgBeanX title_img;
        private String share_h5_url;
        private long id;
        ...
        public TitleImgBeanX getTitle_img() {
          return title_img;
        }

        public void setTitle_img(TitleImgBeanX title_img) {
          this.title_img = title_img;
        }
        ...
        public static class ManagerBean {
          ...
          public static class AnchorLevelBean {
            ...
            public void setProfile_dialog_bg_back(
                ProfileDialogBgBackBean profile_dialog_bg_back) {
          ...
          public static class PayGradeBean {
            ...
            public void setProfile_dialog_bg_back(
                ProfileDialogBgBackBeanX profile_dialog_bg_back) {
              this.profile_dialog_bg_back = profile_dialog_bg_back;
            }
            ...
            public Object getNew_nav_live_icon() {
              return new_nav_live_icon;
            }

            public void setNew_nav_live_icon(Object new_nav_live_icon) {
        ...
        public static class TitleImgBeanX {
          private String uri;
          private List<String> url_list;
      ...
      public static class AuthorBean {
        ...
        private int pay_scores;
        private int income_share_percent;
        private AnchorLevelBeanX anchor_level;
        private boolean allow_others_download_video;
        private boolean is_follower;
        private String hotsoon_verified_reason;
        private int ichat_restrict_type;
        ...
        public AnchorLevelBeanX getAnchor_level() {
          return anchor_level;
        }

        public void setAnchor_level(AnchorLevelBeanX anchor_level) {
          this.anchor_level = anchor_level;
        }
        ...
        public static class AnchorLevelBeanX {
          private int task_start_time;
          private int task_target_experience;
          private int task_start_experience;
          ...
          private SmallIconBeanX small_icon;
          private StageLevelBeanX stage_level;
          ...
          public void setProfile_dialog_bg_back(
              ProfileDialogBgBackBeanXX profile_dialog_bg_back) {
            this.profile_dialog_bg_back = profile_dialog_bg_back;
          }

          public SmallIconBeanX getSmall_icon() {
            return small_icon;
          }

          public void setSmall_icon(SmallIconBeanX small_icon) {
            this.small_icon = small_icon;
          }

          public StageLevelBeanX getStage_level() {
            return stage_level;
          }

          public void setStage_level(StageLevelBeanX stage_level) {
            this.stage_level = stage_level;
          }
          ...
          public static class SmallIconBeanX {
            private String uri;
            private List<String> url_list;
          ...
          public static class StageLevelBeanX {
            private String uri;
            private List<String> url_list;
        ...
        public static class PayGradeBeanX {
          ...
          public ProfileDialogBgBeanXXX getProfile_dialog_bg() {
            return profile_dialog_bg;
          }

          public void setProfile_dialog_bg(ProfileDialogBgBeanXXX profile_dialog_bg) {
            this.profile_dialog_bg = profile_dialog_bg;
          }
          ...
          public ProfileDialogBgBackBeanXXX getProfile_dialog_bg_back() {
            return profile_dialog_bg_back;
          }

          public void setProfile_dialog_bg_back(
              ProfileDialogBgBackBeanXXX profile_dialog_bg_back) {
            this.profile_dialog_bg_back = profile_dialog_bg_back;
          }
        ...
        public static class CommerceInfoBean {
          private boolean enable_show_commerce_sale_item;
          private boolean enable_show_commerce_sale_live;

          public boolean isEnable_show_commerce_sale_item() {
            return enable_show_commerce_sale_item;
          }

          public void setEnable_show_commerce_sale_item(
              boolean enable_show_commerce_sale_item) {
            this.enable_show_commerce_sale_item = enable_show_commerce_sale_item;
          }

          public boolean isEnable_show_commerce_sale_live() {
            return enable_show_commerce_sale_live;
          }

          public void setEnable_show_commerce_sale_live(
              boolean enable_show_commerce_sale_live) {
            this.enable_show_commerce_sale_live = enable_show_commerce_sale_live;
          }
        }
      }
    }
