...
public class SearchUserItemsBean {
  private List<?> hidden_users;
  private List<UsersBean> users;

  public List<?> getHidden_users() {
    return hidden_users;
  }

  public void setHidden_users(List<?> hidden_users) {
    this.hidden_users = hidden_users;
  }
