package com.pinery.fun.joke.util;
 ...
 */
public class LenientConvertFactory extends Converter.Factory {

  /**
   * Create an instance using a default {@link Gson} instance for conversion. Encoding to JSON and
   * decoding from JSON (when no charset is specified by a header) will use UTF-8.
   */
  public static LenientConvertFactory create() {
   ...
   * decoding from JSON (when no charset is specified by a header) will use UTF-8.
   */
  public static LenientConvertFactory create(Gson gson) {
    return new LenientConvertFactory(gson);
  }

  private final Gson gson;

  private LenientConvertFactory(Gson gson) {
